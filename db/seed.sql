...
INSERT INTO agent (license, first_name, last_name, email, phone, web_site) VALUES (123456789, "Abby", "Banksy", "abbybanksy@broker.ca", "416-123-4567", "https://www.abbybanksy.com");
INSERT INTO agent (license, first_name, last_name, email, phone, web_site) VALUES (234567890, "Charles", "Daly", "charlesdaly@broker.ca", "416-234-5678", "https://www.charlesdaly.com");
INSERT INTO agent (license, first_name, last_name, email, phone, web_site) VALUES (345678901, "Kanchani", "Franks", "kanchanifranks@broker.ca", "647-123-4567", "https://www.kanchanifranks.com");
INSERT INTO agent (license, first_name, last_name, email, phone, web_site) VALUES (456789012, "Hashim", "Siyam", "hashimsiyam@broker.ca", "647-456-7890", "https://www.hashimsiyam.com");
INSERT INTO agent (license, first_name, last_name, email, phone, web_site) VALUES (567890123, "Rupam", "Smith", "rupamsmith@broker.ca", "416-789-1234", "https://www.rupamsmith.com");

INSERT INTO consumer (display_name, first_name, last_name, email, phone) VALUES ("Sleepless_in_Toronto", "Annie", "Reed", "anniereed@fake.com", "555-555-5555");
INSERT INTO consumer (display_name, first_name, last_name, email, phone) VALUES ("Neo", "Thomas A.", "Anderson", "thomasaanderson@fake.com", "555-123-4567");
INSERT INTO consumer (display_name, first_name, last_name, email, phone) VALUES ("Super", "Louie", "Kritski", "louiekritski@fake.com", "555-555-1234");

INSERT INTO listing (poster_id, area, listing_status, money, transaction_type) VALUES (1, "E02", "Active", 1000000, "b");
INSERT INTO listing (poster_id, area, listing_status, money, transaction_type) VALUES (2, "E01", "Active", 2000, "a");
INSERT INTO listing (poster_id, area, listing_status, money, transaction_type) VALUES (3, "E11", "Active", 3000, "d");
INSERT INTO listing (poster_id, area, listing_status, money, transaction_type) VALUES (3, "E11", "Active", 1800, "d");
INSERT INTO listing (poster_id, area, listing_status, money, transaction_type) VALUES (3, "E12", "Active", 2500, "d");
INSERT INTO listing (poster_id, area, listing_status, money, transaction_type) VALUES (3, "E06", "Active", 3600, "d");
INSERT INTO listing (poster_id, area, listing_status, money, transaction_type) VALUES (3, "E14", "Active", 3500, "d");
