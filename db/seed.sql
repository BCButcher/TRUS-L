...
INSERT INTO agents (license, phone, web_site, title) VALUES (567890123, "416-789-1234", "https://www.agentsmith.com", "Agent");
...
INSERT INTO users (display_name, first_name, last_name, email, salt, password, agent_id) VALUES ("Agent Smith", "Agent", "Smith", "agentsmith@broker.ca", "c0aaab436e85d15dc64ce380973b8cd8", "797c3afbb2af6594af6ddf807a39bb119f0b35720ebe579f17fdf3d20e3a81a2f79361f81d05319f1c3e0d2c3b598586496a3b324bd44da5c29f9860d7389c6e", 5);

INSERT INTO listings (poster_id, property_address, listing_status, estimated_value, type_of_home) VALUES (1, "1 Main St", "Signed", 1000000, "Detached");
INSERT INTO listings (poster_id, property_address, listing_status, estimated_value, type_of_home) VALUES (2, "1 Zion Ave", "Signed", 800000, "Semi");
...
INSERT INTO listings (poster_id, property_address, listing_status, estimated_value, type_of_home) VALUES (2, "1 Broadview Ave", "Active", 999000, "Semi");
...
INSERT INTO bids (agent_id, listing_id, bid_status, services, message, rejection_reason) VALUES (2, 1, "Rejected", "f", "I will work tirelessly.", "I am rejecting your bid because I am hiring my mother.");
INSERT INTO bids (agent_id, listing_id, bid_status, services, message) VALUES (3, 1, "Signed", "df", "Hire me because I am your mother.");
INSERT INTO bids (agent_id, listing_id, bid_status, services, message, rejection_reason) VALUES (4, 1, "Rejected", "abcdef", "Look at some of the last properties I sold.", "I am rejecting your bid because I am hiring my mother.");
INSERT INTO bids (agent_id, listing_id, bid_status, services, message, rejection_reason) VALUES (5, 1, "Rejected", "eg", "Blah blah blah", "I am rejecting your bid because I am hiring my mother.");
INSERT INTO bids (agent_id, listing_id, bid_status, services, message) VALUES (1, 2, "Signed", "bdef", "Hire me because I am in the top 1% of all realtors in the area.");
INSERT INTO bids (agent_id, listing_id, bid_status, services, message, rejection_reason) VALUES (5, 2, "Rejected", "bdef", "Hello again, Mr. Anderson.", "Another agent has been awarded the contract.");
